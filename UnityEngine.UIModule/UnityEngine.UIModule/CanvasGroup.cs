...
namespace UnityEngine
{
	...
	public sealed class CanvasGroup : Behaviour
	{
		...
		static CanvasGroup()
		{
			...
			CanvasGroup.NativeMethodInfoPtr_get_ignoreParentGroups_Public_get_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CanvasGroup>.NativeClassPtr, 100663303);
			CanvasGroup.NativeMethodInfoPtr_IsRaycastLocationValid_Public_Virtual_Final_New_Boolean_Vector2_Camera_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CanvasGroup>.NativeClassPtr, 100663304);
			CanvasGroup.set_blocksRaycastsDelegateField = IL2CPP.ResolveICall<CanvasGroup.set_blocksRaycastsDelegate>("UnityEngine.CanvasGroup::set_blocksRaycasts");
			CanvasGroup.set_ignoreParentGroupsDelegateField = IL2CPP.ResolveICall<CanvasGroup.set_ignoreParentGroupsDelegate>("UnityEngine.CanvasGroup::set_ignoreParentGroups");
		}

		// Token: 0x17000001 RID: 1
		// (get) Token: 0x06000005 RID: 5 RVA: 0x00002458 File Offset: 0x00000658
		// (set) Token: 0x06000006 RID: 6 RVA: 0x00002494 File Offset: 0x00000694
		public unsafe float alpha
		{
			...
			[CallerCount(2)]
			[CachedScanResults(RefRangeStart = 533506, RefRangeEnd = 533508, XrefRangeStart = 533502, XrefRangeEnd = 533506, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
			set
			{
				IL2CPP.Il2CppObjectBaseToPtrNotNull(this);
				checked
		...
		// (get) Token: 0x06000007 RID: 7 RVA: 0x000024D4 File Offset: 0x000006D4
		// (set) Token: 0x06000008 RID: 8 RVA: 0x00002510 File Offset: 0x00000710
		public unsafe bool interactable
		{
			[CallerCount(2)]
			[CachedScanResults(RefRangeStart = 533512, RefRangeEnd = 533514, XrefRangeStart = 533508, XrefRangeEnd = 533512, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
			get
			{
				IL2CPP.Il2CppObjectBaseToPtrNotNull(this);
				IntPtr* ptr = null;
			...
			[CallerCount(0)]
			[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 533514, XrefRangeEnd = 533518, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
			set
			{
				IL2CPP.Il2CppObjectBaseToPtrNotNull(this);
				checked
		...
		// (get) Token: 0x06000009 RID: 9 RVA: 0x00002550 File Offset: 0x00000750
		// (set) Token: 0x0600000D RID: 13 RVA: 0x00002091 File Offset: 0x00000291
		public unsafe bool blocksRaycasts
		{
			[CallerCount(0)]
			[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 533518, XrefRangeEnd = 533522, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
			get
			{
				IL2CPP.Il2CppObjectBaseToPtrNotNull(this);
				IntPtr* ptr = null;
			...
			set
			{
				CanvasGroup.set_blocksRaycastsDelegateField(IL2CPP.Il2CppObjectBaseToPtrNotNull(this), value);
			}
		}

		// Token: 0x17000004 RID: 4
		// (get) Token: 0x0600000A RID: 10 RVA: 0x0000258C File Offset: 0x0000078C
		// (set) Token: 0x0600000E RID: 14 RVA: 0x000020A4 File Offset: 0x000002A4
		public unsafe bool ignoreParentGroups
		{
			[CallerCount(3)]
			[CachedScanResults(RefRangeStart = 533526, RefRangeEnd = 533529, XrefRangeStart = 533522, XrefRangeEnd = 533526, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
			get
			{
				IL2CPP.Il2CppObjectBaseToPtrNotNull(this);
				IntPtr* ptr = null;
			...
			set
			{
				CanvasGroup.set_ignoreParentGroupsDelegateField(IL2CPP.Il2CppObjectBaseToPtrNotNull(this), value);
			}
		}
		...
		private static readonly CanvasGroup.set_blocksRaycastsDelegate set_blocksRaycastsDelegateField;

		// Token: 0x0400000A RID: 10
		private static readonly CanvasGroup.set_ignoreParentGroupsDelegate set_ignoreParentGroupsDelegateField;

		// Token: 0x0200000A RID: 10
		// (Invoke) Token: 0x0600009A RID: 154
		private delegate void set_blocksRaycastsDelegate(IntPtr @this, bool value);

		// Token: 0x0200000B RID: 11
		// (Invoke) Token: 0x0600009C RID: 156
		private delegate void set_ignoreParentGroupsDelegate(IntPtr @this, bool value);
	}
}
