...
namespace Il2CppMicrosoft.CodeAnalysis
{
	...
	public sealed class EmbeddedAttribute : Attribute
	{
		...
		{
			Il2CppClassPointerStore<EmbeddedAttribute>.NativeClassPtr = IL2CPP.GetIl2CppClass("Unity.Collections.LowLevel.ILSupport.dll", "Microsoft.CodeAnalysis", "EmbeddedAttribute");
