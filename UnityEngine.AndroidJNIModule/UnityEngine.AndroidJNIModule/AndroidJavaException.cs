...
namespace UnityEngine
{
	...
	public sealed class AndroidJavaException : Exception
	{
		...
		static AndroidJavaException()
		{
			...
			AndroidJavaException.NativeMethodInfoPtr__ctor_Internal_Void_String_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AndroidJavaException>.NativeClassPtr, 100663301);
			AndroidJavaException.NativeMethodInfoPtr_get_StackTrace_Public_Virtual_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<AndroidJavaException>.NativeClassPtr, 100663302);
		}

		// Token: 0x0600000B RID: 11 RVA: 0x00002C80 File Offset: 0x00000E80
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 480389, XrefRangeEnd = 480393, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// (get) Token: 0x0600000C RID: 12 RVA: 0x00002CE0 File Offset: 0x00000EE0
		public unsafe override string StackTrace
		{
			[CallerCount(0)]
			[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 480393, XrefRangeEnd = 480395, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
			get
			{
		...
		// (get) Token: 0x0600000E RID: 14 RVA: 0x00002D18 File Offset: 0x00000F18
		// (set) Token: 0x0600000F RID: 15 RVA: 0x00002089 File Offset: 0x00000289
