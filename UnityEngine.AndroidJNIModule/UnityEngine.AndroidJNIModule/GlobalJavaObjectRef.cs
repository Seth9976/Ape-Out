...
namespace UnityEngine
{
	...
	public class GlobalJavaObjectRef : Object
	{
		...
		static GlobalJavaObjectRef()
		{
			...
			GlobalJavaObjectRef.NativeMethodInfoPtr_Finalize_Protected_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GlobalJavaObjectRef>.NativeClassPtr, 100663304);
			GlobalJavaObjectRef.NativeMethodInfoPtr_op_Implicit_Public_Static_IntPtr_GlobalJavaObjectRef_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GlobalJavaObjectRef>.NativeClassPtr, 100663305);
			GlobalJavaObjectRef.NativeMethodInfoPtr_Dispose_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GlobalJavaObjectRef>.NativeClassPtr, 100663306);
		}

		// Token: 0x06000011 RID: 17 RVA: 0x00002DD4 File Offset: 0x00000FD4
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 480395, XrefRangeEnd = 480397, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// Token: 0x06000013 RID: 19 RVA: 0x00002E54 File Offset: 0x00001054
		[CallerCount(3)]
		[CachedScanResults(RefRangeStart = 480401, RefRangeEnd = 480404, XrefRangeStart = 480397, XrefRangeEnd = 480401, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		// (get) Token: 0x06000015 RID: 21 RVA: 0x00002E88 File Offset: 0x00001088
		// (set) Token: 0x06000016 RID: 22 RVA: 0x000020B1 File Offset: 0x000002B1
		...
		// (get) Token: 0x06000017 RID: 23 RVA: 0x00002EB0 File Offset: 0x000010B0
		// (set) Token: 0x06000018 RID: 24 RVA: 0x000020CC File Offset: 0x000002CC
